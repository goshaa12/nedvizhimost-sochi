...
export interface KudepstaNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="q4-2025">4 кв. 2025</option>
                    <option value="q1-2026">1 кв. 2026</option>
                    <option value="q2-2026">2 кв. 2026</option>
                    <option value="q3-2026">3 кв. 2026</option>
                    <option value="q4-2026">4 кв. 2026</option>
                    <option value="q1-2027-plus">1 кв. 2027+</option>
                  </select>
                </div>
