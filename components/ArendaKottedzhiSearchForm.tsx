...
export interface ArendaKottedzhiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function ArendaKottedzhiSearchForm({
  title = 'Подберите коттедж под бюджет за минуту!',
  description = 'Не тратьте время на десятки сайтов. Задайте параметры — и сразу увидите свободные варианты для бронирования.',
  buttonText = 'Показать доступные варианты',
  onButtonClick,
}: ArendaKottedzhiSearchFormProps) {
  return (
