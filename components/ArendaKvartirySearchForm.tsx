...
export interface ArendaKvartirySearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function ArendaKvartirySearchForm({
  title = 'Подберите подходящую квартиру для аренды',
  description = 'Выберите параметры — получите список квартир в Сочи, где можно заселиться в день оформления.',
  buttonText = 'Показать результат',
  onButtonClick,
}: ArendaKvartirySearchFormProps) {
  return (
