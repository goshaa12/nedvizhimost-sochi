...
export interface KrasnayaPolyanaDomaSearchFormProps {
  title?: string;
  description?: string;
...
export function KrasnayaPolyanaDomaSearchForm({
  ...
  onButtonClick,
}: KrasnayaPolyanaDomaSearchFormProps) {
  return (
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900/20"
                      />
                      <span className="text-sm md:text-base text-gray-700">Зарегистрирован</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
