...
export interface KrasnayaPolyanaNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function KrasnayaPolyanaNovostroykiSearchForm({
  title = 'Выберите параметры и находите новостройки быстро',
  description,
  buttonText = 'Показать результат',
  onButtonClick,
}: KrasnayaPolyanaNovostroykiSearchFormProps) {
  return (
