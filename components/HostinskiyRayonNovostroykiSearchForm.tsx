...
export interface HostinskiyRayonNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function HostinskiyRayonNovostroykiSearchForm({
  title = 'Подберите новостройку под ваши параметры',
  description,
  buttonText = 'Показать результаты',
  onButtonClick,
}: HostinskiyRayonNovostroykiSearchFormProps) {
  return (
