...
export interface AdlerNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="q1-2027-plus">1 квартал 2027 и позже</option>
                  </select>
                </div>
