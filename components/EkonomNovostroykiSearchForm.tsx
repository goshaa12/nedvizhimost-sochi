...
export interface EkonomNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="lazarevskoe">Лазаревский</option>
