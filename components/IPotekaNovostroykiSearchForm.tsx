...
export interface IPotekaNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function IPotekaNovostroykiSearchForm({
  title = 'Найдите новостройку под ваши требования',
  description,
  buttonText = 'Показать результат',
  onButtonClick,
}: IPotekaNovostroykiSearchFormProps) {
  return (
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="not-done">Не сдан</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="1kom">1</option>
                    <option value="2kom">2</option>
                    <option value="3kom">3</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-gray-700">Семейная</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900"
                      />
                      <span className="text-sm text-gray-700">Субсидированная</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900"
                      />
                      <span className="text-sm text-gray-700">Господдержка</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900"
                      />
                      <span className="text-sm text-gray-700">От застройщика</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900"
                      />
                      <span className="text-sm text-gray-700">Без первоначального взноса</span>
                    </label>
                  </div>
                </div>
