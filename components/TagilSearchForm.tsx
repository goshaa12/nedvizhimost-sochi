...
export interface TagilSearchFormProps {
  title?: string;
  description?: string;
...
export function TagilSearchForm({
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <input
                    name="area"
                    type="text"
                    placeholder="Укажите метраж, чтобы дом соответствовал потребностям семьи"
                    className="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base rounded-lg bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-900/20"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    name="floor"
                    type="text"
                    placeholder="Выберите предпочитаемый этаж для удобства проживания"
                    className="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base rounded-lg bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-900/20"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm md:text-base text-gray-700">У моря — 5–10 минут прогулки до пляжа, вид на воду</span>
                    </label>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900/20"
                      />
                      <span className="text-sm md:text-base text-gray-700">Ипотека — удобные условия финансирования</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900/20"
                      />
                      <span className="text-sm md:text-base text-gray-700">Вторичка — экономия без потери качества</span>
                    </label>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    name="price"
                    type="text"
                    placeholder="Задайте диапазон для просмотра только доступных домов"
                    className="w-full px-3 md:px-4 py-2.5 md:py-3 text-sm md:text-base rounded-lg bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-900/20"
                  />
                </div>
              </div>
