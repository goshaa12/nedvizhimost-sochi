...
export interface Fz214NovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function Fz214NovostroykiSearchForm({
  title = 'Найдите квартиру под ваши требования!',
  description,
  buttonText = 'Показать результаты',
  onButtonClick,
}: Fz214NovostroykiSearchFormProps) {
  return (
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-emerald-900 border-gray-300 rounded focus:ring-emerald-900"
                      />
                      <span className="text-sm text-gray-700">Только по ФЗ-214</span>
                    </label>
                  </div>
                </div>
