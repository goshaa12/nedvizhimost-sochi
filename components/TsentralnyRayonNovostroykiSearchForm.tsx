...
export interface TsentralnyRayonNovostroykiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function TsentralnyRayonNovostroykiSearchForm({
  title = 'Подберите новостройку под ваши параметры',
  description,
  buttonText = 'Показать результаты',
  onButtonClick,
}: TsentralnyRayonNovostroykiSearchFormProps) {
  return (
