...
export interface Ot60SotokDo1GaUchastkiSearchFormProps {
  title?: string;
  description?: string;
  buttonText?: string;
  onButtonClick?: () => void;
...
export function Ot60SotokDo1GaUchastkiSearchForm({
  title = 'Подберите участок от 60 соток до 1 га за минуту!',
  description,
  buttonText = 'Показать участки от 60 соток',
  onButtonClick,
}: Ot60SotokDo1GaUchastkiSearchFormProps) {
  const [areaFrom, setAreaFrom] = useState('60');
            ...
            >
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">60 соток — 1 га+</p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm md:text-base text-gray-700">Свет рядом или на участке</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="checkbox"
